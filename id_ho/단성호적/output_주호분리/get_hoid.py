...
def extract_data(file, id_dir):
    ...
    for i in sheet.rows:
        ...
        a.append(i[27].value)   #간지
        a.append(i[43].value)   #주성명, 노비인 경우에 사용
        a.append(i[47].value)   #부명
        a.append(i[51].value)   #모명
        a.append(i[56].value)   #조명
        a.append(i[60].value)   #증조명
        a.append(i[64].value)   #외조명
